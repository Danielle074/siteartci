    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="bg-white rounded-lg shadow-lg p-6">
        <div class="grid grid-cols-2 gap-8">
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-600 focus:border-transparent">
        ...
        <div class="flex justify-end space-x-3 mt-6 pt-6 border-t border-gray-200">
          ...
          <button class="px-6 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors">
            Mettre à jour
          </button>
        </div>
      </div>
