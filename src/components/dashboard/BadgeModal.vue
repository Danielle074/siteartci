<template>
  ...
  >
    ...
    <!-- Carte principale -->
    <div class="relative bg-orange-600 text-white w-96 rounded-3xl shadow-lg overflow-hidden pt-4 pb-6">
      ...
      <div class="flex justify-center">
        <div
          class="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-md border-4 border-orange-600 -mt-14"
        >
    ...
    <div class="flex justify-center gap-4 mt-4 mb-8">
      <button
        class="bg-orange-600 text-white px-6 py-3 rounded-lg flex items-center gap-2 shadow  transition-colors"
      >
